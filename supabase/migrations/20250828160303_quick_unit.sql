/*
  # Insert Initial Data for Survey ChatBot
  ...
  2. Features
    ...
    - Rich HTML content for admin responses
    - Proper UUID formatting for all IDs
*/
...
-- Insert surveys (avoid duplicates)
...
-- Insert admin knowledge (avoid duplicates)
